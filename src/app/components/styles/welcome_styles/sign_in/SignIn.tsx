...
export default function SignIn() {
  ...
  const handleEmailSignIn = async (e: React.FormEvent) => {
    e.preventDefault();
    setIsLoading(true);
    // Add your email/password authentication here
  ...
  const handleCreateAccount = () => {
    // Add your navigation to create account page here
  ...
  return (
    <div className='w-full h-screen'>
        ...
        <div className="lg:w-7xl mx-auto h-[85%] bg-gray-50 lg:flex sm:flex-col lg:flex-row">
            ...
            <div className="hidden w-full lg:w-1/2 bg-white lg:block xl:flex xl:items-center xl:justify-center xl:min-h-[300px]">
