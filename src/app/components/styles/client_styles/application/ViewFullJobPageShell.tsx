...
import JobSidebar from "@/app/components/styles/client_styles/application/JobSidebar";

import { viewFullJobMock } from "@/app/components/styles/client_styles/application/mockdata";
      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-6">
        ...
        <div className="mt-5 grid grid-cols-1 gap-4 lg:grid-cols-[1fr_360px]">
          ...
          <section className="space-y-4">
            ...
            <ScreeningQuestionsCard questions={viewFullJobMock.screeningQuestions} />
