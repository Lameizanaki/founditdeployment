export default function ClientNavHeader(){
    return (
        <div className="flex p-2 pt-3 pb-3 justify-between items-center border-b-1 border-black bg-white top-0 z-50 sticky">
            <div className="flex w-full items-center gap-x-8 space-x-4">
            <img className="w-fit h-12" src="/favicon.ico" alt="logo"/>
            <div className='flex w-3xl items-center gap-x-2 h-16 border-t-1 border-b-1 border-[#F3F3F5] bg-gray-100 p-3 rounded-2xl'>
            ...
            <div className="flex items-center justify-between space-x-4 pt-3">
                <div className="flex items-center space-x-8 text-2xl">
                    <div className="flex items-center gap-x-3 hover:cursor-pointer active:opacity-30">
                        {/* jobs */}
                        <p>Jobs</p>
                        <svg className="-mt-3 w-3 h-3" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex items-center gap-x-3 hover:cursor-pointer active:opacity-30">
                    {/* message */}
                    <svg className="-mt-3 w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 14" fill="none">
                    ...
                    <div className="flex items-center gap-x-3 hover:cursor-pointer active:opacity-30">
                    {/* notification */}
                    <svg className="-mt-3 w-7 h-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="w-48 h-14 -mt-4 px-4 py-1 rounded-xl bg-[#00BC7D] active:opacity-30 hover:cursor-pointer">
                    {/* post a job */}
                    <p className="mt-2 text-white">+ Post a Job</p>
                    </div>

                    <div className="w-14 h-14 mr-2 -mt-4 px-3 py-4 rounded-full bg-[#ECECF0] active:opacity-30 hover:cursor-pointer">
                    {/* user */}
                    <svg className="-mt-[10px] w-6 h-6" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
