      ...
      footer={
        <div className="flex items-center justify-end gap-3">
          ...
          <div
            ...
            className="h-10 px-4 rounded-lg bg-purple-600 hover:bg-purple-700 active:bg-purple-700 text-white text-sm font-medium cursor-pointer select-none flex items-center"
          >
            {withdrawLabel}
          </div>
        </div>
    ...
    >
      ...
      <div className="mt-5 flex items-center justify-between">
        ...
        <div
          ...
          className="text-xs text-purple-600 hover:text-purple-700 cursor-pointer select-none flex items-center gap-2"
        >
          ...
          return (
            <div
              ...
              className={`rounded-xl border p-3 flex items-center justify-between gap-4 cursor-pointer select-none
                ${active ? "border-purple-200 bg-purple-50/40" : "border-gray-200 bg-white hover:bg-gray-50"}`}
            >
              <div className="flex items-center gap-3 min-w-0">
                ...
                >
                  {active ? (
                    <div className="w-full h-full rounded-full bg-purple-600 scale-[0.6]" />
                  ) : null}
                </div>
