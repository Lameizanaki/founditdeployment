...
function Trend({ dir, text }: { dir: "up" | "down"; text: string }) {
  const cls = dir === "up" ? "text-green-600" : "text-purple-600";
  const icon =
    dir === "up" ? (
              ...
              {opts.map((o) => (
                <div
                  ...
                  className={`px-3 py-2 text-xs cursor-pointer select-none hover:bg-gray-50 ${
                    value === o ? "text-purple-600 font-medium" : "text-gray-700"
                  }`}
                >
                  {o}
                </div>
          ...
          return (
            <div
              ...
              className={`rounded-xl border p-4 ${
                r.isCurrent ? "border-purple-200 bg-purple-50/40" : "border-gray-200 bg-white"
              }`}
            >
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {r.tag ? (
                      <div className="text-[10px] px-2 py-0.5 rounded-full bg-purple-100 text-purple-700 border border-purple-200">
                        {r.tag}
                      </div>
                    ) : null}
                  </div>
