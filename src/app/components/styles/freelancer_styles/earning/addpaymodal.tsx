      ...
      footer={
        <div className="flex items-center justify-between gap-3">
          ...
          <div
            role="button"
            tabIndex={0}
            className="h-10 flex-1 rounded-lg bg-purple-600 hover:bg-purple-700 active:bg-purple-700 text-white text-sm font-medium cursor-pointer select-none flex items-center justify-center"
          >
            Save & Continue
          </div>
        </div>
