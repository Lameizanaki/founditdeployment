...

      {
        ...
        <div className="bg-white rounded-2xl border border-[rgba(0,0,0,0.1)] mb-6 p-1">
          <div className="p-5 sm:p-6">
            ...
            {/* Attachments */}
            <div>
              <p className="font-['Arial:Regular',sans-serif] leading-3.5 text-[#1a1a1a] text-sm mb-1">
                Attachments
              </p>
              <p className="font-['Arial:Regular',sans-serif] leading-4 text-[#717182] text-xs mb-2">
        ...
        <div className="bg-[#fffbeb] border border-[#fee685] rounded-2xl p-4 mb-6">
          <div className="flex gap-2">
            ...
            <p className="font-['Arial:Regular',sans-serif] leading-5 text-[#7b3306] text-sm">
              By submitting this proposal, you agree to the platform&apos;s
              terms of service. If selected, you&apos;ll enter into a contract
              with the client and be expected to deliver the work as described.
            </p>
          </div>
        </div>
