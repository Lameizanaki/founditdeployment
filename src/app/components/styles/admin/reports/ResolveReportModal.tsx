    ...
    <ModalOverlay onClose={onClose}>
      <div className="w-full max-w-[640px] bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
        <div className="flex items-start justify-between px-6 py-4 border-b border-gray-200">
          <div>
            <div className="text-lg font-semibold text-gray-900">Resolve Report</div>
        ...
        <div className="p-6">
          ...
          <div className="mt-5">
            <div className="text-sm font-medium text-gray-900">Resolution Notes *</div>
            <textarea
            ...
            <div className="mt-2 text-xs text-gray-500">
              Explain what action was taken (e.g., content removed, user warned, etc.)
            </div>
          </div>
          ...
          <div className="mt-6 flex items-center justify-end gap-3">
            ...
            <div
              ...
              onClick={onClose}
              onKeyDown={(e) => handleKeyboardActivate(e, onClose)}
              className="h-10 px-4 rounded-md bg-green-600 hover:bg-green-700 cursor-pointer select-none flex items-center justify-center gap-2 text-sm text-white"
