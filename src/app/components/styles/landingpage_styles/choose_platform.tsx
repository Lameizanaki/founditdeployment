            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3 h-72 mt-10 hover:cursor-pointer">
                {items.map(({ title, subtitle, cta, icon: Icon, onClick }) => (
                    <div
                        ...
                        {/* Icon bubble */}
                        <div
                            className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[#D92AD033] ring-8 ring-[#D92AD033]"
                            aria-hidden="true"
                            >
                        ...
                        <div
                            ...
                            className="inline-flex mt-6 w-full items-center justify-center gap-2
                                    rounded-md bg-[#D92AD0] px-4 py-2 text-white
                                    hover:bg-[#c542bfcc] focus:outline-none focus:ring-2
                                    focus:ring-[#D92AD033] focus:ring-offset-2 disabled:opacity-50"
                        >
                            {cta}
