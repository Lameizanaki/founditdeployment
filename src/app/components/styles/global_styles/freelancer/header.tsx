...
function RoleSwitchModal({
  ...
  const color =
    roleColors[targetRole as keyof typeof roleColors] || roleColors.client;
...
export default function FreelancerNavHeader() {
  const [isJobsDropdownOpen, setIsJobsDropdownOpen] = useState(false);
  const [isUserDropdownOpen, setIsUserDropdownOpen] = useState(false);
  const [currentRole, setCurrentRole] = useState<string>("freelancer");
  ...
  const handleRoleSwitch = async () => {
    ...
    try {
      // Persist role to localStorage (simulate backend)
    ...
    <>
      <div className="flex p-3 -ml-1 pt-2 pb-2 justify-between items-center bg-white top-0 z-50 sticky shadow-sm">
        ...
        <div className="flex w-full items-center gap-x-8 space-x-4">
          <img
            className="hidden lg:block lg:w-fit lg:h-8 xl:block xl:w-fit xl:h-8"
            src="/favicon.ico"
            alt="logo"
        ...
        <div className="flex items-center justify-between space-x-4 pt-3">
          <div className="flex items-center space-x-8 text-xl ml-3 sm:ml-3 lg:ml-3">
            ...
            <div className="sm:flex sm:items-center sm:gap-x-3 lg:flex lg:items-center lg:gap-x-3 xl:flex xl:items-center xl:gap-x-3 hover:cursor-pointer active:opacity-30 hidden">
              <div className="relative" ref={jobsRef}>
                ...
                >
                  <p>Jobs</p>
                  <svg
                    className={`w-3 h-3 -mt-3 transition-transform ${
                  ...
                  <div className="absolute top-full mt-3 w-64 bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden z-50">
                    <div className="py-4 px-6 space-y-5 text-lg text-gray-800">
                      <div
                        ...
                        onClick={() =>
                          handleNavigation("/page/freelancer/orders")
                        }
                      >
                        My Orders
                      </div>
                      <div
                        className="hover:bg-gray-50 cursor-pointer py-2 -mx-6 px-6 transition"
                        onClick={() =>
                          handleNavigation("/page/freelancer/post-job")
                        }
                      >
                        Post a Job
                      </div>
                      <div
                        className="hover:bg-gray-50 cursor-pointer py-2 -mx-6 px-6 transition"
                        onClick={() =>
                          handleNavigation("/page/freelancer/contracts")
                        }
                      >
                        Active Contracts
                      </div>
            ...
            <div
              ...
              onClick={() => handleNavigation("/page/freelancer/messages")}
            >
              <svg
            ...
            <div
              className="hidden xl:block lg:block gap-x-3 hover:cursor-pointer active:opacity-30"
              onClick={() => handleNavigation("/page/freelancer/notifications")}
            >
              <svg
            ...
            <div
              className="w-40 h-10 -mt-4 px-4 py-1 rounded-xl bg-[#615FFF] active:opacity-30 hover:cursor-pointer hidden sm:block xl:block lg:block"
              onClick={() => handleNavigation("/page/freelancer/home")}
            >
              <p className="pt-0.5 text-white text-lg text-center">Find Job</p>
            </div>
                ...
                <div className="absolute right-0 top-full mt-3 w-96 bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden z-50">
                  ...
                  <div className="px-6 py-3">
                    ...
                    <div className="space-y-1">
                      ...
                      >
                        ...
                        <span className="text-gray-900 text-lg flex-1">
                          Client
                        </span>
                        {currentRole === "client" && (
                          <svg
                  ...
                  <div className="px-6 py-3 border-t border-gray-200">
                    ...
                    >
                      ...
                      >
                        ...
                        <path
                          d="M3.52 1.64049L1.96 3.72049C1.65102 4.13247 1.49652 4.33846 1.50011 4.51088C1.50323 4.66093 1.57358 4.80164 1.69175 4.89416C1.82754 5.00049 2.08503 5.00049 2.6 5.00049H17.4C17.915 5.00049 18.1725 5.00049 18.3083 4.89416C18.4264 4.80164 18.4968 4.66093 18.4999 4.51088C18.5035 4.33846 18.349 4.13247 18.04 3.72049L16.48 1.64049M3.52 1.64049C3.696 1.40582 3.784 1.28849 3.89552 1.20386C3.9943 1.12891 4.10616 1.07298 4.22539 1.03893C4.36 1.00049 4.50667 1.00049 4.8 1.00049H15.2C15.4933 1.00049 15.64 1.00049 15.7746 1.03893C15.8938 1.07298 16.0057 1.12891 16.1045 1.20386C16.216 1.28849 16.304 1.40582 16.48 1.64049M3.52 1.64049L1.64 4.14715C1.40254 4.46377 1.28381 4.62207 1.1995 4.79641C1.12469 4.95111 1.07012 5.1148 1.03715 5.28345C1 5.4735 1 5.67138 1 6.06715L1 17.8005C1 18.9206 1 19.4806 1.21799 19.9085C1.40973 20.2848 1.71569 20.5908 2.09202 20.7825C2.51984 21.0005 3.07989 21.0005 4.2 21.0005L15.8 21.0005C16.9201 21.0005 17.4802 21.0005 17.908 20.7825C18.2843 20.5908 18.5903 20.2848 18.782 19.9085C19 19.4806 19 18.9206 19 17.8005V6.06715C19 5.67139 19 5.4735 18.9628 5.28345C18.9299 5.1148 18.8753 4.95111 18.8005 4.79641C18.7162 4.62207 18.5975 4.46377 18.36 4.14715L16.48 1.64049"
                          stroke="#717182"
                          strokeWidth="2"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                  ...
                  <div className="px-6 py-3 border-t border-gray-200 space-y-1">
                    ...
                    >
                      ...
                      <span className="text-gray-900">Purchases</span>
                    </div>
                  ...
                  <div className="px-6 py-3 border-t border-gray-100 space-y-1">
                    <div
                      onClick={() =>
                        handleNavigation("/page/freelancer/setting")
                      }
                      className="flex items-center gap-3 px-3 py-2 hover:bg-gray-50 rounded-lg cursor-pointer transition"
                    >
                      <svg
                    ...
                    >
                      ...
                      >
                        <path
                          d="M3 10H21M7 15H8M12 15H14M6 19H18C19.1046 19 20 18.1046 20 17V7C20 5.89543 19.1046 5 18 5H6C4.89543 5 4 5.89543 4 7V17C4 18.1046 4.89543 19 6 19Z"
                          stroke="#717182"
                          strokeWidth="2"
                          strokeLinecap="round"
                          strokeLinejoin="round"
