    ...
    return (
        ...
        <div className="flex items-center justify-between space-x-4 pt-3">
          <div className="flex items-center space-x-8 text-xl ml-3 sm:ml-3 lg:ml-3">
                ...
                {isJobsDropdownOpen && (
                  <div className="absolute top-full mt-3 w-64 bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden z-50">
                    <div className="py-4 px-6 space-y-5 text-lg text-gray-800">
                      <div className="hover:bg-gray-50 cursor-pointer py-2 -mx-6 px-6 transition" onClick={() => handleNavigation('/page/client/orders')}>
                        My Orders
                      </div>
                      <div className="hover:bg-gray-50 cursor-pointer py-2 -mx-6 px-6 transition" onClick={() => handleNavigation('/page/client/post-job')}>
                        Post a Job
                      </div>
                      <div className="hover:bg-gray-50 cursor-pointer py-2 -mx-6 px-6 transition" onClick={() => handleNavigation('/page/client/active-contracts')}>
                        Active Contracts
                      </div>
                    </div>
                  </div>
            ...
            <div className="w-40 h-10 -mt-4 px-4 py-1 rounded-xl bg-[#615FFF] active:opacity-30 hover:cursor-pointer hidden sm:block xl:block lg:block">
