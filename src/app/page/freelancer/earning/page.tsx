...
import Hero from "@/app/components/styles/freelancer_styles/earning/hero";
import StatRow from "@/app/components/styles/freelancer_styles/earning/statrow";
import Breakdown from "@/app/components/styles/freelancer_styles/earning/breakdown";
import QuickAction from "@/app/components/styles/freelancer_styles/earning/quickaction";
import PayMethod from "@/app/components/styles/freelancer_styles/earning/paymethod";
import Timeline from "@/app/components/styles/freelancer_styles/earning/timeline";
import RecentTx from "@/app/components/styles/freelancer_styles/earning/recent";
import { handleKeyboardActivate } from "@/app/components/styles/freelancer_styles/earning/utils";
...
import WithdrawModal from "@/app/components/styles/freelancer_styles/earning/withdrawmodal";
import AddPayModal from "@/app/components/styles/freelancer_styles/earning/addpaymodal";
    ...
    <div className="bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div
          ...
          tabIndex={0}
          aria-label="Back"
          onClick={() => router.push("/page/freelancer/landingpage")}
          onKeyDown={(e) =>
            handleKeyboardActivate(e, () => router.push("/page/freelancer/landingpage"))
          }
            ...
            <QuickAction
              items={[
                ...
                },
                {
                  ...
                  icon: <IconDoc />,
                  onClick: () => router.push("/page/freelancer/earning/taxinfo"),
                },
                {
                  id: "statement",
